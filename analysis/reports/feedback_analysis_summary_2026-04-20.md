...
full_match 0.149946 0.184628 +0.034682
EI         0.652361 0.596076 -0.056285
SN         0.553112 0.700887 +0.147775
TF         0.652897 0.658963 +0.006066
JP         0.581009 0.650363 +0.069354
```

结论：这版值得作为 `0.3.1-sn-jp1` 实验版发出，但 E/I 下滑是明确副作用。后续不要继续加权，先收新版 feedback，再排查 `q23` 与 `q37` 对 E/I 的外溢影响。
